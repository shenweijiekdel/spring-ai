...
import org.springframework.ai.qwen.api.QwenApi.ChatCompletionChunk;
import org.springframework.ai.qwen.api.QwenApi.ChatCompletionChunk.ChunkChoice;
import org.springframework.ai.qwen.api.QwenApi.ChatCompletionFinishReason;
...
import org.springframework.ai.qwen.api.QwenApi.ChatCompletionMessage.Role;
 ...
 * @author Geng Rong
 */
public class QwenStreamFunctionCallingHelper {
	...
	public ChatCompletionChunk merge(ChatCompletionChunk previous, ChatCompletionChunk current) {
		...
		QwenApi.Usage usage = (current.usage() != null ? current.usage() : previous.usage());
	...
	private ChunkChoice merge(ChunkChoice previous, ChunkChoice current) {
		...
		QwenApi.LogProbs logprobs = (current.logprobs() != null ? current.logprobs() : previous.logprobs());
