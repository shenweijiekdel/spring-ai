...
import org.springframework.ai.qwen.api.ResponseFormat;
...
public class QwenChatOptions implements ToolCallingChatOptions {
	...
	private @JsonProperty("tools") List<QwenApi.FunctionTool> tools;
	 ...
	 * {@link QwenApi.ChatCompletionRequest.ToolChoiceBuilder} to create a tool choice
	 * object.
	 */
	 ...
	 * Think on off
	 */
	private @JsonProperty("chat_template_kwargs") boolean chatTemplateKwargs;
	...
	public List<QwenApi.FunctionTool> getTools() {
		return this.tools;
	}

	public void setTools(List<QwenApi.FunctionTool> tools) {
		this.tools = tools;
	}
	...
	@Nullable
	@JsonIgnore
	public boolean getChatTemplateKwargs() {
		return this.chatTemplateKwargs;
	}

	public void setChatTemplateKwargs(boolean chatTemplateKwargs) {
	...
	public QwenChatOptions copy() {
		return QwenChatOptions.fromOptions(this);
	}
	...
	public int hashCode() {
		return Objects.hash(this.model, this.frequencyPenalty, this.logprobs, this.topLogprobs,
				...
				this.toolCallbacks, this.toolNames, this.internalToolExecutionEnabled, this.toolContext,this.chatTemplateKwargs);
	}
	...
	public boolean equals(Object o) {
		...
		QwenChatOptions other = (QwenChatOptions) o;
	...
	public static class Builder {
		...
		public Builder(QwenChatOptions options) {
		...
		public Builder model(QwenApi.ChatModel qwenAiChatModel) {
			this.options.model = qwenAiChatModel.getName();
			return this;
		}
		...
		public Builder tools(List<QwenApi.FunctionTool> tools) {
			this.options.tools = tools;
			return this;
		}

		public Builder chatTemplateKwargs(boolean chatTemplateKwargs) {
