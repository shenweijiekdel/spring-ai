...
public class QwenApi {
	...
	public static final ChatModel DEFAULT_CHAT_MODEL = ChatModel.QWEN_CHAT;
	...
	private QwenStreamFunctionCallingHelper chunkMerger = new QwenStreamFunctionCallingHelper();
	 ...
	 */
	public QwenApi(String baseUrl, ApiKey apiKey, MultiValueMap<String, String> headers, String completionsPath,
	...
	public static class Builder {
		...
		private String baseUrl = QwenConstants.DEFAULT_BASE_URL;

		private ApiKey apiKey;

		private MultiValueMap<String, String> headers = new LinkedMultiValueMap<>();

		private String completionsPath = QwenConstants.DEFAULT_COMPLETIONS_PATH;

		private String betaPrefixPath = QwenConstants.DEFAULT_BETA_PATH;
		...
		public QwenApi build() {
			...
			return new QwenApi(this.baseUrl, this.apiKey, this.headers, this.completionsPath, this.betaPrefixPath,
