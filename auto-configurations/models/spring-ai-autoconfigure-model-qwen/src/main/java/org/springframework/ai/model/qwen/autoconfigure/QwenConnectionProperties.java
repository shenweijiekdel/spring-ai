 ...
 * @author Geng Rong
 */
@ConfigurationProperties(QwenConnectionProperties.CONFIG_PREFIX)
public class QwenConnectionProperties extends QwenParentProperties {
	...
	public QwenConnectionProperties() {
