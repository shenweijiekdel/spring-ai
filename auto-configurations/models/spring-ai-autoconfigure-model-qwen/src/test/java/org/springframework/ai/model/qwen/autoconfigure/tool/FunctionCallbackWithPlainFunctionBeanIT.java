...
// @Disabled("the qwen-chat model's Function Calling capability is unstable see:
// https://api-docs.qwen.com/guides/function_calling")
	...
	void functionCallTest() {
		this.contextRunner.run(context -> {
			...
			ChatResponse response = chatModel.call(new Prompt(List.of(userMessage),
					QwenChatOptions.builder().toolNames("weatherFunction").build()));
			...
			response = chatModel.call(new Prompt(List.of(userMessage),
					QwenChatOptions.builder().toolNames("weatherFunctionTwo").build()));
