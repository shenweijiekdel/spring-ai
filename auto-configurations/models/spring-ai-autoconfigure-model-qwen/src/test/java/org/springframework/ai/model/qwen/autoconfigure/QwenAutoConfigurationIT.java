...
public class QwenAutoConfigurationIT {

	private static final Log logger = LogFactory.getLog(QwenAutoConfigurationIT.class);
	...
	void generate() {
		this.contextRunner.run(context -> {
			QwenChatModel client = context.getBean(QwenChatModel.class);
